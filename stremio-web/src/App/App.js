...
const KaiBootstrap = require('../kai/KaiBootstrap');
const { KAI_FEATURES } = require('../kai/config');
...
const App = () => {
    ...
    React.useEffect(() => {
        // Kai: disable Stremio cloud sync / remote addon pulls
        if (KAI_FEATURES.disableCloudSync) {
            return undefined;
        }
